...
//Adapted from https://superkogito.github.io/blog/CaptureScreenUsingGdiplus.html
...
bool saveToMemory(HBITMAP* hbitmap, std::vector<BYTE>& data) {
    ...
    HRESULT createResult = CreateStreamOnHGlobal(NULL, TRUE, &istream);

    // define encoding
    CLSID clsid;
    HRESULT clsidFromStringResult = CLSIDFromString(L"{557cf400-1a04-11d3-9a73-0000f81ef32e}", &clsid);
    ...
    HGLOBAL hg = NULL;
    HRESULT getHGlobalResult = GetHGlobalFromStream(istream, &hg);
